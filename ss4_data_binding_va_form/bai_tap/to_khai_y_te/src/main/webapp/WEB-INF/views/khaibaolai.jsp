...
<div>
    <div class="text-center">
        ...
        <strong>ĐÂY LÀ TÀI LIỆU QUAN TRỌNG, THÔNG TIN CỦA ANH/CHỊ SẼ GIÚP CƠ QUAN Y TẾ LIÊN LẠC KHI CÀN THIẾT ĐỂ PHÒNG
            CHÓNG
            DỊCH BỆNH TRUYỀN NHIÊM</strong>
        <strong class="text-danger"> Khuyến cáo: Khai báo thông tin sai là vi phạm pháp luật Việt Nam và có thể xử lý
            hình
            sự </strong>
    </div>

    <form:form action="/dakhaibao" method="post" modelAttribute="tokhaibaolai" cssClass="align-content-center">
        <div class="container">
            ...
            <table>
                ...
                <tr>
                    <td><p> Đến trang trại chăn nuôi / chợ buôn bán động vật sống / cơ sở giết mổ động vật / tiếp
                        xúc
                        động vật
                ...
                <tr>
                    <td>
                        <p>Tiếp xúc gần (<2m) với người mắc bệnh viêm đường hô hấp do nCoV<span
                                class="batbuoc">(*)</span>
                        </p>
                    </td>
                    <td><form:radiobutton path="phatBan" value="true"/></td>
            ...
            <button type="submit" class="btn btn-success text-white rounded-pill"> KHAI BÁO</button>
        </div>
    </form:form>
